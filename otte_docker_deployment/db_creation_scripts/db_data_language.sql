...
('LOCATION.SHIELD_GENERATORS.NAME',             'Shield Generators', 'Skjoldgeneratorer'),
('LOCATION.SHIELD_GENERATORS.DESCRIPTION',      'Powerful generators that create a protective shield around the colony', 'Kraftfulde generatorer der skaber et beskyttende skjold omkring kolonien'),
