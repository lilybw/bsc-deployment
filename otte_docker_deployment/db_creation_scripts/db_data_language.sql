...
('LOCATION.RADAR_DISH.NAME',                    'Radar', 'Radar'),
...
('TUTORIAL.LOCATION_TRIAL.DESCRIPTION',         'Visit the Fort', 'Besøg Fortet'),
('TUTORIAL.MULTPLAYER.DESCRIPTION',             'To have your friends come visit your colony, enter the Space Port, and open the colony. Finally, close the colony before leaving.', 'For at venner kan besøge din koloni, besøg Rumhavnen, og åben kolonien. Luk kolonien igen før du forlader den.'),
