...
'{
    "minTimeTillImpactS": 7,
    "maxTimeTillImpactS": 11,
    "charCodeLength": 2,
    "asteroidsPerSecondAtStart": 0.8,
    "asteroidsPerSecondAt80Percent": 0.8,
    "colonyHealth": 3,
    "asteroidMaxHealth": 1,
    "stunDurationS": 1,
...
'{
    "asteroidsPerSecondAtStart": 0.8,
    "asteroidsPerSecondAt80Percent": 1.6,
    "colonyHealth": 5,
    "minTimeTillImpactS": 6,
    "maxTimeTillImpactS": 9,
    "asteroidMaxHealth": 2,
    "charCodeLength": 3,
    "survivalTimeS": 240
}'),
...
'{
    "asteroidsPerSecondAtStart": 1.6,
    "asteroidsPerSecondAt80Percent": 3,
    "colonyHealth": 5,
    "minTimeTillImpactS": 5,
    "maxTimeTillImpactS": 7,
    "asteroidMaxHealth": 3,
    "charCodeLength": 4,
    "survivalTimeS": 300
}');
